...
$ecms_config['db']['dbtbpre']='nanxi_';	//数据表前缀
...
//后台安全设置
$ecms_config['esafe']['loginauth']='shenshuang';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['ecookiernd']='0NXhUW6KxxnbKgYF1xbBzimR7xtmAb';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='qylsv';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='qpgrc';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='aWaI94AR8GsARZdByF5CtdSMK1dXfd';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='QllUdnoR3sbrxOZ5XSLBgkA77eNSAB';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'2AugVYUTIrB5SnyflbsEV51ny0IOWy',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/cms/news/\">新闻中心</a>&nbsp;|&nbsp;<a href=\"/cms/download/\">下载中心</a>&nbsp;|&nbsp;<a href=\"/cms/movie/\">影视频道</a>&nbsp;|&nbsp;<a href=\"/cms/shop/\">网上商城</a>&nbsp;|&nbsp;<a href=\"/cms/flash/\">FLASH频道</a>&nbsp;|&nbsp;<a href=\"/cms/photo/\">图片频道</a>&nbsp;|&nbsp;<a href=\"/cms/article/\">文章中心</a>&nbsp;|&nbsp;<a href=\"/cms/info/\">分类信息</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
