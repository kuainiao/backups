...
class AliziAction extends Action{
        ...
        protected $aliziConfig="";//楠溪王配置信息
        protected $aliziHost =""; //楠溪王地址
    ...
    function aliziAuth(){
        ...
        // die('<!DOCTYPE html><html><head><meta charset="utf-8"><title>楠溪王订单管理系统</title></head><body>域名：'.$host.' 未授权，请联系作者！<br>旺旺：justo2008<br>店铺：https://Hiweb.taobao.com</body></html>');
    }
    ...
    // 空操作，草他吗的没有的方法，让他妈我找半天，一个现成的项目，自己写的链接竟然没有方法实现，草
