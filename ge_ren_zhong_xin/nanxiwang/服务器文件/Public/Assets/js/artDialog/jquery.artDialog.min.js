...
$.alert = function (content, icon, callback) {
	...
	if(!isNaN(icon)){ content = '<table><tr><td class="icon icon-'+icon+'"></td><td style="font-size:14px;">'+content+'</td></tr></table>';}
    return $.dialog({id: 'Alert',fixed: true,lock: true,content: content,ok: true,padding:'20px 30px 0 30px', beforeunload: callback});
};
$.confirm = function (content, ok, cancel) {
	content = '<table><tr><td class="icon icon-3"></td><td style="font-size:14px;">'+content+'</td></tr></table>';
    return $.dialog({id: 'Confirm',fixed: true,lock: true,content: content,ok: ok,cancel: cancel});
};
