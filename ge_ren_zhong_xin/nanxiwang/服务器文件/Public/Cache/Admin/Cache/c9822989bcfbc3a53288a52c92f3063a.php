    ...
    <div id="CooperationMain" class="box clear-fix">   
        <div class="layout-block-header">
            <form action="__SELF__" method="get" id="searchform">
                ...
                <select name="fields">
                    <?php $fields=array('order_no'=>lang('order_number'),'item_name'=>lang('item_name'),'name'=>lang('customer_realname'),'mobile'=>lang('customer_mobile'),'channel_id'=>lang('channel'),'user_id'=>lang('user_id'),'referer'=>lang('来路搜索')); ?>
                ...
                <button type="submit" class="btn" name="aliziExcel"><?php echo lang('export_order');?></button>
                ...
                <div class="search-list filter clear-fix">
                    ...
                    <select name="user_pid">
                        <option value="0"><?php echo lang('select_agent');?></option>
                        <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($vo["id"]) == $_GET['user_pid']): ?>selected<?php endif; ?>><?php echo ($vo["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                ...
                <table cellpadding = "0" cellspacing = "0" width = "100%" >
                    <thead>
                        <tr class = "ui-table-head">
                            ...
                            <th class = "ui-table-hcell"><?php echo lang('item_name');?>__<?php echo lang('item_package');?></th>
                            <!-- <th class = "ui-table-hcell" width = "85"><?php echo lang('combo');?></th> -->
                            <th class = "ui-table-hcell" width = "50"><?php echo lang('amount_price');?></th>
                            <!-- <th class = "ui-table-hcell" width = "60"><?php echo lang('buy_name');?></th> -->
                            <th class = "ui-table-hcell" width = "90"><?php echo lang('customer');?>_<?php echo lang('realname');?>_<?php echo lang('phone');?></th>
                            <th class = "ui-table-hcell" width = "50"><?php echo lang('buy_province');?></th>
                            <th class = "ui-table-hcell" width = "50"><?php echo lang('buy_city');?></th>
                            <th class = "ui-table-hcell" width = "50"><?php echo lang('buy_area');?></th>
                            <th class = "ui-table-hcell" width = "150"><?php echo lang('buy_address');?></th>
                            <th class = "ui-table-hcell" width = "50"><?php echo lang('payment_status');?></th>
                            <th class = "ui-table-hcell" width = "40"><?php echo lang('express');?></th>
                            <th class = "ui-table-hcell" width = "100"><?php echo lang('remark');?></th>
                            <th class = "ui-table-hcell" width = "60"><?php echo lang('agent');?></th>
                            <th class = "ui-table-hcell" width = "85"><?php echo lang('time');?></th>
                            <th class = "ui-table-hcell" width = "80"><?php echo lang('action');?></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id = "row-<?php echo ($vo["id"]); ?>">
                            ...
                            <td><?php echo ($vo["item_name"]); if(!empty($vo["item_params"])): ?><p><?php echo ($vo["item_params"]); ?></p><?php endif; ?></td>
                            <!-- <td><?php echo ($vo["item_params"]); ?></td> -->
                            ...
                            <td><?php echo (getfields("User","username",$vo["user_pid"])); ?></td>
                            <td><?php echo (date("y-m-d H:i",$vo["add_time"])); ?></td>
                            <td class = "action">
                                <a <?php if(in_array('orderModify',$_SESSION['user']['auth'])): ?>href="<?php echo U('Order/'.ACTION_NAME,array('do'=>'modify','id'=>$vo['id'],'status'=>$_GET['status']));?>"<?php else: ?>href="javascript:;" class="grey"<?php endif; ?>><?php echo lang('modify');?></a> |
