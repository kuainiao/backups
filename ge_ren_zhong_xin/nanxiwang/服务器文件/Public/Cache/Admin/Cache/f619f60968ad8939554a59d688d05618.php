                ...
                <table cellpadding="0" cellspacing="0" width="100%" >
                    <thead>
                        <tr class="ui-table-head">
                            ...
                            <th class="ui-table-hcell"><?php echo lang('group');?></th>
                    ...
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="row-<?php echo ($vo["id"]); ?>">
                            ...
                            <td><?php echo (getfields("UserGroup","name",$vo["group_id"])); ?></td>
                            ...
                            <td class="action">
								...
								<q <?php if(($vo["id"]) == "1"): ?>class="grey"<?php else: ?>onclick="javascript:Delete('<?php echo ($vo["id"]); ?>','<?php echo U('User/proccess/',array('do'=>'delete','id'=>$vo['id']));?>')"<?php endif; ?>><?php echo lang('delete');?></q>
                            </td>
