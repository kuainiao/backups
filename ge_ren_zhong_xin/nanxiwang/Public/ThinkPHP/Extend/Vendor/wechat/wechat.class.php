...
<Nonce><![CDATA[%s]]></Nonce>
	...
	protected function setCache($cachename,$value,$expired){
		...
		$json = json_encode(array('expired'=>$expired+time(),'data'=>$value));
		file_put_contents("./Public/Cache/{$cachename}.json", $json);
		return false;
	}
	...
	protected function getCache($cachename){
		...
		$json = file_get_contents("./Public/Cache/{$cachename}.json");
