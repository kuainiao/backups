                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="left">
                                    ...
                                    <input name="price" type="text" class="ui-text" value="<?php echo ($info["price"]); ?>" size="4">
                                    <span class="ui-validityshower-info"><?php echo lang('yuan');?></span>
                                    <span class="ui-validityshower-info">现价不为空，则显示现价折扣区域，为空则不显示</span>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="ui-validityshower-info">添加规则</span>
                                <br/>
                                <span class="ui-validityshower-info">事例</span>
                                <br/>
                                <span class="ui-validityshower-info">套餐1#combo1</span>
                                <br/>
                                <span class="ui-validityshower-info">套餐2#combo2</span>
                                <br/>
                                <span class="ui-validityshower-info">商品1#goods1</span>
                                <br/>
                                <span class="ui-validityshower-info">商品2#goods2</span>
                                <br/>
                                <div class="item-list">
                                    <?php if(!empty($info["params"])): if(is_array($info["params"])): $i = 0; $__LIST__ = $info["params"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="rows clearfix">

                                                <label><?php echo lang('name_colon');?></label>
                                                <input name="title[]" type="text" class="ui-text" value="<?php echo ($vo["title"]); ?>" size="15">

                                                <label><?php echo lang('price_colon');?></label>
                                                <input name="params_price[]" type="text" class="ui-text" value="<?php echo ($vo["price"]); ?>" size="4">

                                                <!-- 上传图片区域 -->
                                                <div class="image">
                                                    <label><?php echo lang('image_colon');?></label>
                                                    <input name="params_image[]" type="text" class="ui-text" value="<?php echo ($vo["image"]); ?>" id="image-<?php echo ($key); ?>" size="15">
                                                    <button id="btn-image-<?php echo ($key); ?>" type="button" class="btn-upload" onclick="upload('#btn-image-<?php echo ($key); ?>','#image-<?php echo ($key); ?>')"></button>
                                                </div>

                                                <!-- 二维码区域 -->
                                                <!-- <div class="qrcode <?php if(!empty($info["qrcode_pay"])): ?>show<?php endif; ?>">
                                                    <label>
                                                        <b class="verifing">*</b><?php echo lang('qrcode_colon');?></label>
                                                        <input name="params_qrcode[]" type="text" class="ui-text  validate[required]" value="<?php echo ($vo["qrcode"]); ?>" id="qrcode-<?php echo ($key); ?>" size="15">
                                                        <button id="btn-<?php echo ($key); ?>" type="button" class="btn-upload" onclick="upload('#btn-<?php echo ($key); ?>','#qrcode-<?php echo ($key); ?>')"></button>
                                                </div> -->

                                                <input type="button" class="ui-button" value="<?php echo lang('delete');?>" onclick="itemDel($(this))" style = 'margin-left: 3px;'/>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>
                                    ...
                                    <br/>
                                    <span class="ui-validityshower-info">添加规则__对应上面添加的套餐</span>
                                    <br/>
                                    <span class="ui-validityshower-info">套餐1</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(套餐1#combo1)__内容(衣服搭配一)__套餐图片</span>
                                    <br/>
                                    <span class="ui-validityshower-info">套餐里面的各个衣服尺寸颜色等</span>
                                    <br/>
                                    <span class="ui-validityshower-info">property从0开始依次递增</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(套餐1#combo1property0/衣服一/颜色)__内容(红色#白色#紫色)</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(套餐1#combo1property0/衣服一/尺码)__内容(170#175#180)</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(套餐1#combo1property1/衣服二/颜色)__内容(红色#白色#紫色)</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(套餐1#combo1property1/衣服二/尺码)__内容(170#175#180)</span>
                                    <br/>
                                    <span class="ui-validityshower-info">套餐2</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(套餐2#conbo2)__内容(衣服搭配二)__套餐图片</span>
                                    <br/>
                                    <span class="ui-validityshower-info">套餐里面的各个衣服尺寸颜色等</span>
                                    <br/>
                                    <span class="ui-validityshower-info">property从0开始依次递增</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(套餐2#combo2property0/衣服一/颜色)__内容(红色#白色#紫色)</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(套餐2#combo2property0/衣服一/尺码)__内容(170#175#180)</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(套餐2#combo2property1/衣服二/颜色)__内容(红色#白色#紫色)</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(套餐2#combo2property1/衣服二/尺码)__内容(170#175#180)</span>
                                    <br/>
                                    <span class="ui-validityshower-info">衣服1</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(衣服1#goods1/颜色)__内容(红色#白色#紫色)</span>
                                    <br/>
                                    <span class="ui-validityshower-info">衣服2</span>
                                    <br/>
                                    <span class="ui-validityshower-info">名称(衣服2#goods2/颜色)__内容(红色#白色#紫色)</span>
                                    <br/>
                                </p>
                                <div class="extend-list">
                                    <?php if(!empty($info["extends"])): if(is_array($info["extends"])): $i = 0; $__LIST__ = $info["extends"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="rows clearfix">
                                            ...
                                            <!-- 上传图片区域 -->
                                            <!-- 修改套餐上传图片 -->
                                            <div class="image" style = 'padding-left: 3px;'>
                                                <label><?php echo lang('image_colon');?></label>
                                                <input name="extend_image[]" type="text" class="ui-text" value="<?php echo ($vo["image"]); ?>" id="combo-<?php echo ($key); ?>" size="15">
                                                <button id="up-combo-<?php echo ($key); ?>" type="button" class="btn-upload" onclick="upload('#up-combo-<?php echo ($key); ?>','#combo-<?php echo ($key); ?>')"></button>
                                            </div>

                                            <input type="button" class="ui-button" value="<?php echo lang('delete');?>" onclick="itemDel($(this))" style = 'margin-left: 3px;'/></div><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                                </div>
                            </td>
                        </tr>
                        <tr>
...
function itemForm()
{
    ...
    var rand = new Date().getTime();
    var select = "<select name='extend_type[]' style = 'margin-right:3px;'><option value='radio'>单选项</option></select>";
    var item = '<div class="rows clearfix"><label><?php echo lang('name_colon');?></label><input name="extend_title[]" type="text" class="ui-text" value="<?php echo ($info["title"]); ?>" size="6"><label> <?php echo lang('内容_colon');?></label><input name="extend_value[]" type="text" class="ui-text" value="" size="40">'+select+'<label><?php echo lang('image_colon');?></label><input name="extend_image[]" type="text" class="ui-text" value="<?php echo ($info["image"]); ?>"  id="combo-image-'+rand+'" size="15"><button id="up-combo-image-'+rand+'" type="button" class="btn-upload" onclick="upload(\'#up-combo-image-'+rand+'\',\'#combo-image-'+rand+'\')" style = "margin-right: 3px;"></button><input type="button" class="ui-button" value="<?php echo lang('delete');?>" onclick="itemDel($(this))" style = "margin-left:3px;"/></div>';
