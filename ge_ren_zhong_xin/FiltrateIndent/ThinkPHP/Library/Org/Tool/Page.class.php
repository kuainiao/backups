...
class page
{
    ...
    public function __construct($total, $number)
    {
        ...
        $this->countNow = !empty($_GET['page'])?$_GET['page']:1;
    }
    ...
    private function lists()
    {
        ...
        for($i=$num;$i>=1;$i--){
            ...
            if($count>1){
                $lists .= '&nbsp;<a href = "'.$this->uri.'&page='.$count.'">'.$count.'</a>&nbsp;';
            }
        }
    ...
    private function last()
    {
        if($this->countNow<$this->count){
            ...
            return  '<a href = "'.$this->uri.'&page='.$next.'">&nbsp;下一页&nbsp;</a><a href = "'.$this->uri.'&page='.$this->count.'">&nbsp;末页&nbsp;</a>';
        }else{
            return '';
        }
    }
