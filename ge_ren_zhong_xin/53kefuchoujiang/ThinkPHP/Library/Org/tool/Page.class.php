...
// var_dump($url);
    ...
    public function page()
    {
        ...
        $countTool[0] = '&nbsp总共&nbsp;'.$this->total.'&nbsp;条&nbsp';
        $countTool[1] =  '&nbsp;本页显示&nbsp;'.$this->num().'&nbsp;条&nbsp';
        $countTool[2] = '&nbsp显示&nbsp;'.$this->start().'&nbsp;到&nbsp;'.$this->end().'条&nbsp';
        $countTool[3] = '&nbsp;第&nbsp;'.$this->countNow.'&nbsp;页&nbsp共&nbsp;'.$this->count.'&nbsp;页&nbsp;';
