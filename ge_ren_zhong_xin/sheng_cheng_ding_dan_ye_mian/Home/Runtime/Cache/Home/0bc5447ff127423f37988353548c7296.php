...
<head>
    <title>上传订单页面</title>
<link rel = 'stylesheet' type = 'text/css' href = '/Public/Css/body1.css'>
...
<script type = 'text/javascript' src = '/Public/Js/check.js'></script>
    ...
    <div class = 'body'>
        <form action = '/index.php/home/handle/DoUp' method = 'post' enctype = 'multipart/form-data' class = 'form' id = 'form' onsubmit = 'return CheckForm(this)'>
