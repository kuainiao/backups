    ...
    <div class = 'body2'>
        ...
        <?php if(is_array($info)): foreach($info as $key=>$v): ?><div class = 'info'>
                <ul>
                    ...
                    <li id = 'handle'>
                        <a href = '/index.php/Home/IndentStatistics/Handles?act=add&g_id=<?php echo ($v["id"]); ?>'>
                            <span>增加</span>
                        </a>
                        <a href = '/index.php/Home/IndentStatistics/Handles?act=del&g_id=<?php echo ($v["id"]); ?>'>
                            <span>删除</span>
                        </a>
                        <a href = '/index.php/Home/IndentStatistics/Handles?act=upd&g_id=<?php echo ($v["id"]); ?>'>
                            <span>更新</span>
                        </a>
                        <a href = ''>
                            <span>暂无</span>
