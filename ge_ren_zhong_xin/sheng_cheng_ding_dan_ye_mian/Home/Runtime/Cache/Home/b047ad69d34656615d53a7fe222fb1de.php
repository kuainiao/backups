...
<link rel = 'stylesheet' type = 'text/css' href = '/Public/Css/body2.css'>
        ...
        <?php if(is_array($info)): foreach($info as $key=>$v): ?><div class = 'info'>
                <ul>
                    ...
                    <li id = 'handle'>
                        ...
                        <?php if($v["img"] == null): ?><a href = '/index.php/Home/Handle/HandleGoodsImg?&id=<?php echo ($v["id"]); ?>'>
                        ...
                        <?php else: ?>
                            ...
                            <?php if($v["img"] == null): ?><a href = '/index.php/Home/Handle/DownIndentBody?&id=<?php echo ($v["id"]); ?>' class = 'down' onclick = "if(confirm('没有商品图片信息，\n是否确定下载') == false) return false; ">
                                    <span>下载</span>
                                    <br/>
                                    <span class = 'red'>未添加商品图片信息</span>
                                </a>
                            <?php else: ?>
                                <a href = '/index.php/Home/Handle/DownIndentBody?&id=<?php echo ($v["id"]); ?>' class = 'down' >
                                    <span>下载</span>
                                    <br/>
